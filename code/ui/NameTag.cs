...
namespace Freezetag 
{
    internal class NameTagComponent : EntityComponent<FreezeBasePlayer>
    {
        NameTag NameTag;
        ...
        {
            foreach ( var player in Sandbox.Entity.All.OfType<FreezeBasePlayer>() )
            {
