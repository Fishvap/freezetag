...
namespace Freezetag
{
	...
	/// </summary>
	internal class NameTagComponent : EntityComponent<BasePlayer>
	{
		...
		{
			foreach ( var player in Sandbox.Entity.All.OfType<BasePlayer>() )
			{
	...
	public class NameTag : WorldPanel
	{
		...
		internal NameTag( string title, long? steamid )
		{
			...
			PanelBounds = new Rect( -500, -100, 1000, 400 );
		}
	}
}